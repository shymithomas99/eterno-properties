...
@push('modal')      
    ...
    <!-- Delete Modal-->
    <div class="modal fade" id="delete-banner-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger btn-delete-banner "><i class="fa fa-trash"></i> Delete</button>
    ...
    $('#banner-table').DataTable({
     ...
     $('table').on('click','.banner-delete', function(e){
        var href=$(this).data('href');
            $('.btn-delete-banner').off().click(function() {
		      $.ajax({
