                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <textarea name="content" rows="3" class="form-control">{{ old('content', $testimonial->content) }}</textarea>
                            @error('content')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="customer_place" class="form-control"
                        ...
                        <div class="form-group col-md-6">
                            <label><strong>Customer Image (100 × 100 px, max 30 KB) <span
                                        class="text-danger">*</strong></label>
                            <div class="custom-file mb-3">
                                <input type="file" class="custom-file-input" id="customer_image" name="customer_image"
                                    accept="image/*"
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="form-group col-6">
                            <button type="submit"
                                class="btn btn-primary mr-3">{{ $testimonial->id ? 'Update' : 'Save' }}</button>
