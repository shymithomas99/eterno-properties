    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0"
        ...
        <tr>
            <td style="padding:25px;">
                <p style="margin-top:0;font-size:15px;">You have received a new booking enquiry through the website.</p>
                ...
                <table width="100%" cellpadding="10" cellspacing="0" border="0"
                    ...
                    @if ($enquiry->phone)
                        <tr style="background:#f8f9fa;">
                            <td style="font-weight:bold;border:1px solid #dee2e6;">Phone</td>
                            <td style="border:1px solid #dee2e6;">{{ $enquiry->phone }}</td>
                        </tr>
                    @endif
                    ...
                    <tr>
                        <td style="font-weight:bold;border:1px solid #dee2e6;">Submitted On</td>
                        <td style="border:1px solid #dee2e6;">{{ $enquiry->created_at->format('d M Y, h:i A') }}</td>
                    </tr>
        ...
        <tr>
            <td style="background:#f8f9fa;padding:18px;text-align:center;font-size:13px;color:#666;">This enquiry was
                submitted through the <strong>Eterno Hotels & Resorts</strong> website.</td>
        </tr>
